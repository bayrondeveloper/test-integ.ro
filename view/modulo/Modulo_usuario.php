...
<?php $nom_mod="Usuarios";?>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><?=$nom_mod?> <a href="?N=form_usuario" class="btn btn-warning btn-circle btn-lg">
                   +</i>
                  </a></h1>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="tabla" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    echo '<td> 
                    <a href="?N=form_usuario&cript='.$id.'" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>  
                    ';
                    ?>
                    <h9 id_eli="<?=$row['cript'];?>">
